...
io.on('connection', socket => {
  ...
  socket.on('wearItem', item => socket.broadcast.to(socket.currentRoom).emit('generalMessage', {from: socket.username, feedback: ` wears ${item.equipment.short} on their ${item.equipment.slot}.`}));
