...
export const roomData = {
  'Nexus': {
    ...
    items: [newItem('corpse'), newItem('backpack'), newItem('backpack'), newItem('health potion'), newItem('gallows key'), newItem('health potion'), newItem('tester key'), newItem('mana potion')],
    examines: [{
      name: 'test examine',
      terms: ['test'],
